...
class FinalChart extends Component {
  constructor(props) {
    ...
    this.confidenceInterval =
      ...
      this.calculateYield(this.result.slopeConfidenceInterval);
  }
        ...
        <div className="d-flex flex-row justify-content-center">
          <div style={{ width: 700, height: 600 }}>
            ...
            <div className="d-flex flex-row justify-content-between">
              ...
              <CopyButton
                text={createYieldTSVFile({ data: this.getExportData() })}
              />
              <SavePatternButton
                patternType={ExcelPatternTypes.RAD_CHEM_YIELD}
              />
            </div>
          </div>
        </div>
