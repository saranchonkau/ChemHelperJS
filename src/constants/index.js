...
export const calibrationTableColumnDefs = [
    ...
    { headerName: 'Concentration', field: 'concentration', width: 130, ...editableNumberProps, format: numberFormatter },
    { headerName: 'Optical Density', field: 'density', width: 165, ...editableNumberProps },
    { headerName: 'On/Off', field: 'isSelected', width: 90, type: CellTypes.CHECK_BOX },
    { type: CellTypes.REMOVE, width: 70 }
];

export const calculationWithMACColumnDefs = [
    { headerName: '\u2116', field: 'id', width: 70 },
    { headerName: 'Optical Density', field: 'density', width: 130, ...editableNumberProps },
    { headerName: 'Concentration', field: 'concentration', width: 165, ...editableNumberProps, format: numberFormatter },
    { type: CellTypes.REMOVE, width: 70 }
];

export const opticalDensityTableColumnDefs = [
    { headerName: '\u2116', field: 'id', width: 70 },
    { headerName: 'Optical Density', field: 'density', width: 175, ...editableNumberProps },
    { headerName: 'Concentration', field: 'concentration', width: 175, ...editableNumberProps, format: numberFormatter },
    { type: CellTypes.REMOVE, width: 70 }
];

export const finalTableColumnDefs = [
    { headerName: '\u2116', field: 'id', width: 70 },
    { headerName: 'Time, min', field: 'time', width: 130, ...editableNumberProps },
    { headerName: 'Concentration', field: 'concentration', width: 165, ...editableNumberProps, format: numberFormatter },
    { headerName: 'On/Off', field: 'isSelected', width: 90, type: CellTypes.CHECK_BOX },
    { type: CellTypes.REMOVE, width: 70 }
];
...
export const nuclidesTableColumnDefs = [
    ...
    { headerName: 'A', field: 'atomic_mass', width: 170, format: atomicMassFormatter },
];
